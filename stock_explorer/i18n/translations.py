...
_AI_LAB_TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    "de": {
        ...
        "ai.history_error_detail": "Kurshistorie konnte nicht geladen werden: {error}",
        "ai.runtime_mode": "Laufzeitmodus",
        "ai.runtime_mode.quick": "Schnell",
        "ai.runtime_mode.standard": "Standard",
        "ai.runtime_mode.intensive": "Intensiv",
        "ai.runtime_mode.custom": "Benutzerdefiniert",
        "ai.history_years": "Analysehistorie",
        "ai.history_all": "Alle verfügbaren Daten",
        "ai.history_value": "Letzte {years} Jahre",
        ...
        "ai.max_folds": "Maximale Test-Folds",
        "ai.max_minutes": "Laufzeitlimit in Minuten",
        "ai.limits_notice": (
            "Fold- und Zeitlimits werden zwischen vollständigen Walk-forward-Fenstern geprüft. "
            "Ein bereits laufender Fold wird sauber abgeschlossen."
        ),
        "ai.quality.title": "Datenqualität der verwendeten Historie",
        "ai.quality.score": "Qualitätsscore",
        "ai.quality.level": "Status",
        "ai.quality.observations": "Kurspunkte",
        "ai.quality.years": "Jahre",
        "ai.quality.level.good": "Gut",
        "ai.quality.level.warning": "Prüfen",
        "ai.quality.level.poor": "Schwach",
        "ai.quality.issues": "Hinweise: {issues}",
        "ai.quality.issue.invalid_rows": "ungültige Zeilen",
        "ai.quality.issue.duplicates": "doppelte Zeitpunkte",
        "ai.quality.issue.nonpositive_prices": "nicht positive Kurse",
        "ai.quality.issue.many_gaps": "viele Datenlücken",
        "ai.quality.issue.some_gaps": "einige Datenlücken",
        "ai.quality.issue.stale": "veralteter Datenstand",
        "ai.quality.issue.slightly_stale": "Datenstand möglicherweise verzögert",
        "ai.quality.issue.short_history": "zu kurze Historie",
        "ai.quality.issue.limited_history": "begrenzte Historie",
        "ai.quality.issue.empty": "keine verwertbaren Daten",
        "ai.plan_error": "Arbeitsplan konnte nicht erstellt werden: {error}",
        "ai.workload.title": "Aufwand und Laufzeitschätzung",
        "ai.workload.folds": "Geplante Folds",
        "ai.workload.steps": "Trainingsschritte",
        "ai.workload.estimate": "Geschätzte Laufzeit",
        "ai.workload.risk": "Laufzeitrisiko",
        "ai.workload.risk.low": "Niedrig",
        "ai.workload.risk.medium": "Mittel",
        "ai.workload.risk.high": "Hoch",
        "ai.workload.notice": (
            "Die Schätzung basiert auf typischer lokaler Python-Leistung und kann je nach PC, Datenmenge "
            "und Hintergrundlast deutlich abweichen."
        ),
        "ai.clear_cache": "Berechnungs-Cache leeren",
        "ai.cache_cleared": "Der Cache für vorbereitete KI-Labor-Daten wurde geleert.",
        "ai.progress.starting": "Bereite Walk-forward-Lauf vor …",
        "ai.progress.training": "Trainiere Fold {fold} von {total} · bisher {elapsed}",
        "ai.progress.fold_complete": "Fold {fold} von {total} abgeschlossen · bisher {elapsed}",
        "ai.progress.complete": "Analyse vollständig abgeschlossen.",
        "ai.progress.stopped": "Analyse an einer sicheren Fold-Grenze beendet.",
        "ai.partial_result": (
            "Teilergebnis: {completed} von {planned} geplanten Folds wurden abgeschlossen. Grund: {reason}."
        ),
        "ai.stop_reason.time_limit": "Laufzeitlimit erreicht",
        "ai.stop_reason.fold_limit": "Fold-Limit erreicht",
        "ai.stop_reason.unknown": "unbekannter Abbruchgrund",
        "ai.duration.seconds": "{value} Sek.",
        "ai.duration.minutes": "{value} Min.",
        "ai.duration.hours": "{value} Std.",
    ...
    "en": {
        ...
        "ai.history_error_detail": "Price history could not be loaded: {error}",
        "ai.runtime_mode": "Runtime mode",
        "ai.runtime_mode.quick": "Quick",
        "ai.runtime_mode.standard": "Standard",
        "ai.runtime_mode.intensive": "Intensive",
        "ai.runtime_mode.custom": "Custom",
        "ai.history_years": "Analysis history",
        "ai.history_all": "All available data",
        "ai.history_value": "Last {years} years",
        ...
        "ai.seed": "Random seed",
        "ai.max_folds": "Maximum test folds",
        "ai.max_minutes": "Runtime limit in minutes",
        "ai.limits_notice": (
            "Fold and time limits are checked between complete walk-forward windows. "
            "A fold already in progress is completed cleanly."
        ),
        "ai.quality.title": "Data quality of the selected history",
        "ai.quality.score": "Quality score",
        "ai.quality.level": "Status",
        "ai.quality.observations": "Price observations",
        "ai.quality.years": "Years",
        "ai.quality.level.good": "Good",
        "ai.quality.level.warning": "Review",
        "ai.quality.level.poor": "Poor",
        "ai.quality.issues": "Notes: {issues}",
        "ai.quality.issue.invalid_rows": "invalid rows",
        "ai.quality.issue.duplicates": "duplicate timestamps",
        "ai.quality.issue.nonpositive_prices": "non-positive prices",
        "ai.quality.issue.many_gaps": "many data gaps",
        "ai.quality.issue.some_gaps": "some data gaps",
        "ai.quality.issue.stale": "stale data",
        "ai.quality.issue.slightly_stale": "possibly delayed data",
        "ai.quality.issue.short_history": "history too short",
        "ai.quality.issue.limited_history": "limited history",
        "ai.quality.issue.empty": "no usable data",
        "ai.plan_error": "Work plan could not be created: {error}",
        "ai.workload.title": "Workload and runtime estimate",
        "ai.workload.folds": "Scheduled folds",
        "ai.workload.steps": "Training steps",
        "ai.workload.estimate": "Estimated runtime",
        "ai.workload.risk": "Runtime risk",
        "ai.workload.risk.low": "Low",
        "ai.workload.risk.medium": "Medium",
        "ai.workload.risk.high": "High",
        "ai.workload.notice": (
            "The estimate assumes typical local Python performance and may vary materially with hardware, "
            "data volume and background load."
        ),
        "ai.clear_cache": "Clear calculation cache",
        "ai.cache_cleared": "The cache for prepared AI-lab data was cleared.",
        "ai.progress.starting": "Preparing walk-forward run …",
        "ai.progress.training": "Training fold {fold} of {total} · elapsed {elapsed}",
        "ai.progress.fold_complete": "Completed fold {fold} of {total} · elapsed {elapsed}",
        "ai.progress.complete": "Analysis completed in full.",
        "ai.progress.stopped": "Analysis stopped at a safe fold boundary.",
        "ai.partial_result": (
            "Partial result: completed {completed} of {planned} scheduled folds. Reason: {reason}."
        ),
        "ai.stop_reason.time_limit": "runtime limit reached",
        "ai.stop_reason.fold_limit": "fold limit reached",
        "ai.stop_reason.unknown": "unknown stop reason",
        "ai.duration.seconds": "{value} sec",
        "ai.duration.minutes": "{value} min",
        "ai.duration.hours": "{value} h",
